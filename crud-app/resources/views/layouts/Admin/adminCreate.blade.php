...
<body>
  ...
  <nav class="navbar bg-light">
    <div class="container-fluid">
      ...
      <button type="button" class="btn btn-primary position-relative bg-success bg-opacity-75 border-0">
      ...
      <a class="navbar-brand btn-t btn btn-sm btn-danger text-white p-0 px-2" href="{{route('admin.logout')}}"><i class="bi bi-box-arrow-in-left"></i> Logout</a>
    </div>
  </nav>
  <!-- nav end -->
